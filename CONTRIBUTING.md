...
We use [GitHub](https://github.com/braillerap/TestBrailleRAP) to manage the project and you can report new issues or weigh in on existing ones via our [issue tracker](https://github.com/braillerap/TestBrailleRAP/issues).


## How to contribute to translation
You can contribute translation for the TestBrailleRAP software itself, but you can also translate the user manual. We use [weblate](https://translate.codeberg.org/) hosted on [codeberg](https://codeberg.org/) to manage software and documentation translation. 
...
Another way to get contribute is to improve the documentation, look for typos, improve phrasing, the examples and the gallery. This does not require to build TestBrailleRAP or to learn programming language and is a very important work!


## How to Get Started With Development

To contribute to TestBrailleRAP as a developer, first you may want to try and build TestBrailleRAP for yourself.
...
## TestBrailleRAP Development Workflow

- [Fork](https://github.com/braillerap/TestBrailleRAP/fork) the TestBrailleRAP repository on GitHub.
...
- As soon as possible , create a draft pull request against `https://github.com/braillerap/TestBrailleRAP/main` so that maintainers are aware and design can be discussed.
...
- The `main` now contains your changes and will be present in the next minor/major release, any documentation related changes are visible on [documentation](https://TestBrailleRAP.readthedocs.io/fr/latest/)!
